package com.roam.daemon.strategy;
...
import com.roam.daemon.IDaemonStrategy;
import com.roam.daemon.nativ.NativeDaemonAPI20;
...
public class DaemonStrategyUnder21 implements IDaemonStrategy {
	...
	public void onPersistentCreate(final Context context, final DaemonConfigurations configs) {
		...
		Thread t = new Thread(){
			public void run() {
				Log.e("daemon",context.getPackageName());
