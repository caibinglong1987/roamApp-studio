...
public abstract class HttpManager {
    ...
    public abstract void postJsonRequest(String url, JSONObject requestJson, int hashCodeTag, final HttpCallback callback);

    public abstract void postJsonRequest(String url, JSONObject requestJson, int hashCodeTag, int timeout, final HttpCallback callback);
