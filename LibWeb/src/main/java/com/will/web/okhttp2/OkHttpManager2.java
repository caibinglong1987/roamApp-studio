 ...
 */
public class OkHttpManager2 extends HttpManager {
...
//     * @param params   参数
//     */
//    public void RequestObject(int method, String url, Map<String, Object> params, final HttpCallback callback) {
