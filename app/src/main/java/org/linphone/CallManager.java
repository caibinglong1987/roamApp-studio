...
public class CallManager {
	...
	public void setRecordFile(LinphoneCall call, String recordFile){
		LinphoneCore lc = LinphoneManager.getLc();
		LinphoneCallParams params = call.getCurrentParamsCopy();
		params.setVideoEnabled(false);
		params.setRecordFile(recordFile);
		bm().updateWithProfileSettings(params);

	}
	
	public void inviteAddress(LinphoneAddress lAddress, boolean videoEnabled, boolean lowBandwidth, String recordfile) throws LinphoneCoreException {
		LinphoneCore lc = LinphoneManager.getLc();
	...
	public void inviteAddress(LinphoneAddress lAddress, boolean videoEnabled, boolean lowBandwidth) throws LinphoneCoreException {
		inviteAddress(lAddress, videoEnabled, lowBandwidth, null);
	}
