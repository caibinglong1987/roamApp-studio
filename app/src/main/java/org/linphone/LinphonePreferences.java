...
public class LinphonePreferences {
	...
	private LinphoneCore getLc() {
		...
		return LinphoneManager.getInstance().getLcIfManagerNotDestroyedOrNull();
	}
	...
	public static class AccountBuilder {
		...
		public AccountBuilder setExtention(String phone) {
		...
		public void saveNewAccount() throws LinphoneCoreException {
			...
			String identity = "sip:" + tempPhoneNumber + "@" + tempDomain;//String identity = "sip:" + tempUsername + "@" + tempDomain;
			String proxy = "sip:";
			if (tempProxy == null) {
				proxy += tempDomain;
			} else {
	...
	public void enableAutoRecording(Boolean recording){
		getConfig().setBool("app", "auto_recording_enabled", recording);
	}

	public Boolean isAutoRecordingEnabled(){
		return getConfig().getBool("app", "auto_recording_enabled", false);
	}	
	public void enableAgc(Boolean agc){
		getConfig().setBool("sound", "agc", agc);
	}

	public Boolean isAgcEnabled(){
		return getConfig().getBool("sound", "agc", false);
	}		
}
