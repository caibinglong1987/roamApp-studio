...
public class HistoryDetailFragment extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (LinphoneActivity.isInstanciated()) {
			if (id == R.id.dialBack) {
				LinphoneActivity.instance().setAddressGoToDialerAndCall(LinphoneUtils.getUsernameFromAddress(sipUri), displayName, pictureUri == null ? null : Uri.parse(pictureUri));
