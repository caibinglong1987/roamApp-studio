package com.roamtech.telephony.roamapp.helper.pinyin;
...
public final class PinyinHelper {
    ...
    public static String toChangeLowerCase(String str) {
     ...
     * @return
     */
    public static String toChangeUpperCase(String str) {
        StringBuffer sb = new StringBuffer();
        if (str != null) {
            for (int i = 0; i < str.length(); i++) {
                char c = str.charAt(i);
     ...
     * @return
     */
    public static boolean containCase(String str) {
