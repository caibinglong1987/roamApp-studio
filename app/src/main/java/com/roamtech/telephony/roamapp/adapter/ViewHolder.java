...
public class ViewHolder {
    ...
    public ViewHolder setImageUrlByNetworkImage(int viewId, String url){
        ImageView img = getView(viewId);
        //img.setImageURI(UriHelper.obtainUri(url),imageLo);
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .cacheInMemory(true)
                .cacheOnDisk(true)
                .build();
        ImageLoader.getInstance().displayImage(url, new ImageViewAware(img), options);
        return this;
    }
