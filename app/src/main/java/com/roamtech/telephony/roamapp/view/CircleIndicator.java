...
public class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.circle_scale_with_alpha;
    private int mAnimatorReverseResId = 0;
    private int mIndicatorBackgroundResId = R.drawable.circle_white_radius;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.circle_white_radius;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                R.animator.circle_scale_with_alpha);
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                        R.drawable.circle_white_radius);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.circle_scale_with_alpha, 0, R.drawable.circle_white_radius, R.drawable.circle_white_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.circle_scale_with_alpha : mAnimatorResId;
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.circle_white_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
    ...
    public void setViewPager(ViewPager viewPager,boolean isLoop) {
