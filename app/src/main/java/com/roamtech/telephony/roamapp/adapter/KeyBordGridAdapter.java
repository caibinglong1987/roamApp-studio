...
import com.roamtech.telephony.roamapp.helper.KeyboardHelper.Key;
import com.roamtech.telephony.roamapp.R;
import com.roamtech.telephony.roamapp.base.BaseActivity;

public class KeyBordGridAdapter extends RMBaseAdapter<Key> {

	public KeyBordGridAdapter(BaseActivity activity, List<Key> data) {
		super(activity, data);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.item_keyboard_grid, parent,
					false);
