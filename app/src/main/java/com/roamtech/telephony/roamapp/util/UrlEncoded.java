...
import com.roamtech.telephony.roamapp.util.Utf8Appendable.NotUtf8Exception;
...
public class UrlEncoded extends MultiMap implements Cloneable
{
    ...
    {
        if (charset==null || __UTF8.equalsIgnoreCase(charset))
        {
                        ...
                        try
                        {
                            if ('u'==encoded.charAt(offset+i+1))
                            {
                                if((i+5)<length)
                                {
                                    int o=offset+i+2;
                                    i+=5;
                                    String unicode = new String(Character.toChars(parseInt(encoded,o,4,16)));
                            ...
                            else
                            {
                                int o=offset+i+1;
                                i+=2;
                                byte b=(byte)parseInt(encoded,o,2,16);
                                buffer.append(b);
                            }
                        }
                        catch(NotUtf8Exception e)
                                ...
                                if(i+2<length)
                                {
                                    try
                                    {
                                        ...
                                        else
                                        {
                                            int o=offset+i+1;
                                            i+=3;
                                            ba[n]=(byte)parseInt(encoded,o,2,16);
                                            n++;
                                        }
                                    }
                                    catch(NumberFormatException nfe)
